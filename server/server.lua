...
AddEventHandler("rsg-fishing:FishToInventory", function(fishModel, weight)
    ...
    TriggerClientEvent('rsg-inventory:client:ItemBox', src, RSGCore.Shared.Items[fish], "add")
    TriggerClientEvent('ox_lib:notify', source, {title = Lang:t('primary.you_got_fish_name',{fish_name = fish_name}), type = 'success', duration = 5000 })
